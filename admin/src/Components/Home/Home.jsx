...
import AddCSRImage from "../../Pages/Csv/AddCSRImage";
import EditCSRImage from "../../Pages/Csv/EditCSRImage";
        ...
        <>
          ...
          <div className="rightside">
            <Routes>
              ...
              <Route
                path={"/edit-instupment/:id"}
                element={<EditInstupment />}
              />
              {/* Product --  */}
              <Route path={"/all-inplants-products"} element={<AllProduct />} />
              <Route path={"/add-inplants-product"} element={<AddProduct />} />
              <Route
                path={"/edit-inplants-product/:id"}
                element={<EditProduct />}
              />
              {/* Product --  */}
              <Route
                path={"/all-instupment-products"}
                element={<AllInstupmentProduct />}
              />
              <Route
                path={"/add-instupment-product"}
                element={<AddInstupmentProduct />}
              />
              <Route
              ...
              />
              <Route
                path={"/edit-instupment-product/:id"}
              ...
              <Route
                ...
                element={<AllCertificateImage />}
              />{" "}
              {/* // All Vouchers */}
              <Route
                path={"/add-certificate"}
                element={<AddCertificateImage />}
              />
              <Route
                path={"/edit-certificate/:id"}
                element={<EditCertificateImage />}
              />
              <Route path={"/all-event-image"} element={<AllEventImage />} />{" "}
              {/* // All Vouchers */}
              <Route path={"/add-event-image"} element={<AddEventImage />} />
              <Route
                path={"/edit-event-image/:id"}
                element={<EditEventImage />}
              />
              {/* --- Tags --- */}
